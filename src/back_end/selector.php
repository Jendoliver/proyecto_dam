...
if(isset($_POST["login"])) // Venimos de index.php, el usuario quiere iniciar sesión
{
    ...
    switch($usertype) // Guardamos las variables que modifican el espacio personal y redirigimos al que toca según el tipo de usuario
    {
        ...
        case 1: getSession($_POST["username"], $usertype); $_SESSION["token"] = 1; header("Location: ../front_end/fan.php"); break;
        case 2: getSession($_POST["username"], $usertype); $_SESSION["token"] = 1; header("Location: ../front_end/banda.php"); break;
        case 3: getSession($_POST["username"], $usertype); $_SESSION["token"] = 1; header("Location: ../front_end/local.php"); break;
    }
}
/*else if
{
